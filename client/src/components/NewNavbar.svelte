	...
	>
		...
		>
			<div class="flex items-center">
				<button class="lg:hidden"
					><svg
						...
						><path d="M3 6H21V8H3V6ZM3 11H21V13H3V11ZM3 16H21V18H3V16Z" fill="#03081A" /></svg
					></button
				>
				<a href="/"
					><div
						class="max-w-[96px] max-h-[32px] md:max-w-[105px] md:max-h-[47px] flex items-center"
					>
						<img
			...
			<div class="flex items-center gap-[8px] xl:gap-[16px]">
				...
				<button
					type="button"
					class="bg-transparent border border-red-500 !text-primary-red-500 hover:bg-ms-red-100 focus-visible:bg-white rounded-[8px] !font-[600] text-[14px] leading-[24px] font-sans tracking-[1.25px] uppercase p-[12px_16px] inline-block focus:!ring-0 outline-offset-[5px] outline-[1px] outline-[transparent] focus-visible:!shadow-[0_0_0_3px_rgba(66,_153,_225,_0.6)] disabled:opacity-[0.6] disabled:cursor-not-allowed transition-[background-color,border-color,color,fill,stroke,opacity,box-shadow,transform] duration-200 hidden md:block"
					>sign up</button
				>
				<button
					type="button"
...
>
	<div
		class="absolute grid closed lg:hidden w-screen bg-white border-none svelte-159q009"
		style="--endingHeight: 100vh; --startingHeight: 0vh; transition: max-height 0.3s ease-out 0s, grid-template-rows 0.3s ease-out 0s;"
	>
